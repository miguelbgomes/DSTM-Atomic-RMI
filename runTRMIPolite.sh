...
for i in $(seq 0 0);
do
  time -p java -classpath ".;./TRMIPolite" DSTMBenchmark.GenericDSTM.GenericCoordinator $NSERVER $NCLIENT $NOBJSERVER&
  #printf "java -classpath .:./TRMIPolite DSTMBenchmark.GenericDSTM.GenericCoordinator $NSERVER $NCLIENT $NOBJSERVER&\n"
