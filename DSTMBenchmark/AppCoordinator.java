	...
	public void runCoordinator(ProcessData processData, String [] args){
       ...
       // args[2] = NUMBER OF OBJECTS
		...
		DBarrier barrier = new DBarrier(numberOfClients+1);
                ...
                serverbarrier.await();
				//System.out.println("servers waited");


                // waits for clients to be up:
				//System.out.println("wait for clients");
                barrier.await();
				//System.out.println("clients waited");
                long start = System.currentTimeMillis(); 
				//System.out.println("wait for clients to finish");
                barrier.await();// waits for all clients to finish
                long end = System.currentTimeMillis();
				//System.out.println("clients finish waited");
